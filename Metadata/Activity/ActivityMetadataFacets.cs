...
namespace ClipFlair.Metadata
{
  ...
  public static class ActivityMetadataFacets
  {
    public const string FACET_FOR_LEARNERS = "For learners of";
    public const string FACET_FOR_SPEAKERS = "For speakers of";
    ...
    public const string FACET_RESPONSES = "Responses";
